...
import { NoDrinksFound } from "#/app/ui/search/no-drinks-found";
import { NoSearchTerm } from "#/app/ui/search/no-search-term";
import { SearchForm } from "#/app/ui/search/search-form";
import { Searching } from "#/app/ui/search/searching";
...
export async function loader({ request }: Route.LoaderArgs) {
  ...
  const drinks = await drinksService.searchPublishedDrinks({ query: q ?? "" });
  ...
  return data(
    ...
    {
      headers: {
        "Surrogate-Key": q ? "search all" : "all",
